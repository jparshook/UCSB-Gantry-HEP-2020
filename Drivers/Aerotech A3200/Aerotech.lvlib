...
<Library LVVersion="20008000">
	...
	<Item Name="Aerotech A3200" Type="Folder">
		<Item Name="Bin" Type="Folder">
			<Item Name="Data" Type="Folder">
				<Item Name="Aerotech.A3200.dll" Type="Document" URL="../Bin/Data/Aerotech.A3200.dll"/>
				<Item Name="Aerotech.A3200.LabVIEW.dll" Type="Document" URL="../Bin/Data/Aerotech.A3200.LabVIEW.dll"/>
			</Item>
			<Item Name="A32Cmplr.dll" Type="Document" URL="../Bin/A32Cmplr.dll"/>
			<Item Name="A32Cmplr64.dll" Type="Document" URL="../Bin/A32Cmplr64.dll"/>
			<Item Name="A32Sys.dll" Type="Document" URL="../Bin/A32Sys.dll"/>
			<Item Name="A32Sys64.dll" Type="Document" URL="../Bin/A32Sys64.dll"/>
			<Item Name="A3200 LabVIEW Operator Interface.exe" Type="Document" URL="../Bin/A3200 LabVIEW Operator Interface.exe"/>
			<Item Name="A3200 LabVIEW Operator Interface.ini" Type="Document" URL="../Bin/A3200 LabVIEW Operator Interface.ini"/>
			...
			<Item Name="Aerotech.Common.dll" Type="Document" URL="../Bin/Aerotech.Common.dll"/>
			<Item Name="AerUtilities.dll" Type="Document" URL="../Bin/AerUtilities.dll"/>
			<Item Name="AerUtilities64.dll" Type="Document" URL="../Bin/AerUtilities64.dll"/>
			<Item Name="LicenseDecoder.dll" Type="Document" URL="../Bin/LicenseDecoder.dll"/>
			<Item Name="LicenseDecoder64.dll" Type="Document" URL="../Bin/LicenseDecoder64.dll"/>
		</Item>
